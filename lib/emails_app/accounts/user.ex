defmodule EmailsApp.Accounts.User do
  use Ecto.Schema
  ...
  def registration_changeset(user, attrs, opts \\ []) do
    user
    |> cast(attrs, [:email_address, :password, :first_name, :last_name, :msisdn])
    |> validate_email(opts)
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email_address, EmailsApp.Repo)
  ...
  """
  def valid_password?(%EmailsApp.Accounts.User{hashed_password: hashed_password}, password)
